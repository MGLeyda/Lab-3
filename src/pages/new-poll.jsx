...
function NewPoll(props) {
  ...
  const handleRemoveClick = index => {
    ...
    const handlePublish = ()=> {
        ...
        const title = createPoll.title.value;
        const location = createPoll.location.value;
        const timeZone = createPoll.timeZone.value;
        const notes = createPoll.notes.value;
        const dateMM = createPoll.dateMM.value;
        const dateDD = createPoll.dateDD.value;
        const dateYY= createPoll.dateYY.value;
        const startTimeHH = createPoll.startTimeHH.value;
        const startTimeMM = createPoll.startTimeMM.value;
        const startAMPM= createPoll.startAMPM.value;
        const endTimeHH = createPoll.endTimeHH.value;
        const endTimeMM = createPoll.endTimeMM.value;
        const endAMPM= createPoll.endAMPM.value;
        const timeSlots= createPoll.timeSlots.value;
        const restrictVotesPoll= createPoll.restrictVotesPoll.value;
        const restrictVotesPerson= createPoll.restrictVotesPerson.value;
        const invite= createPoll.invite.value;
        const remind= createPoll.remind.value;
